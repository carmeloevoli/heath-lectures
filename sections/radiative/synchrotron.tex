...
In most sources the radiating electrons span a broad range of energies. The most common modelization is a power–law in Lorentz factor,
\[
n(\gamma)\,d\gamma = n_0\,\gamma^{-p}\,d\gamma,
\qquad
\gamma_{\min}<\gamma<\gamma_{\max},
\]
with slopes $p\simeq2$–$3$ in many astrophysical environments. 
%
