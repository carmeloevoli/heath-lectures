...
\]
Assuming a TeV photon, Using the head-on threshold condition for pair production, at the dominant target photons have energies
\[
\epsilon_{\rm th} \simeq~{\rm eV}\,,
\]
